...
const gateArrow    = { type: 'arrow', color: '#854F0B', width: 14, height: 14 };
...
export const INITIAL_EDGES = [
  ...
  { id: 'e-intel-orch',      source: 'intel',        target: 'orchestration', markerEnd: dotArrow,   style: { stroke: '#534AB7', strokeWidth: 1.5, strokeDasharray: '5 4' }, label: 'context',         labelStyle: { fill: '#534AB7', fontSize: 11 }, labelBgStyle: { fill: '#fbfbfa' } },
  { id: 'e-intel-workers',   source: 'intel',        target: 'workers',       markerEnd: dotArrow,   style: { stroke: '#534AB7', strokeWidth: 1.5, strokeDasharray: '5 4' }, label: 'context',         labelStyle: { fill: '#534AB7', fontSize: 11 }, labelBgStyle: { fill: '#fbfbfa' } },
  ...
  { id: 'e-verify-learn',    source: 'verification', target: 'learn',         markerEnd: dotArrow,   style: { stroke: '#534AB7', strokeWidth: 1.5, strokeDasharray: '5 4' }, label: 'traces',          labelStyle: { fill: '#534AB7', fontSize: 11 }, labelBgStyle: { fill: '#fbfbfa' } },
  { id: 'e-learn-workers',   source: 'learn',        target: 'workers',       markerEnd: dotArrow,   style: { stroke: '#534AB7', strokeWidth: 1.5, strokeDasharray: '5 4' }, label: 'skills, memory',  labelStyle: { fill: '#534AB7', fontSize: 11 }, labelBgStyle: { fill: '#fbfbfa' } },
  { id: 'e-learn-intel',     source: 'learn',        target: 'intel',         markerEnd: dotArrow,   style: { stroke: '#534AB7', strokeWidth: 1.5, strokeDasharray: '5 4' }, label: 'exemplars',       labelStyle: { fill: '#534AB7', fontSize: 11 }, labelBgStyle: { fill: '#fbfbfa' } },
  { id: 'e-sec-verify',      source: 'security',     target: 'verification',  markerEnd: dotArrow,   style: { stroke: '#534AB7', strokeWidth: 1.5, strokeDasharray: '5 4' }, label: 'adversarial pass',labelStyle: { fill: '#534AB7', fontSize: 11 }, labelBgStyle: { fill: '#fbfbfa' } },
  { id: 'e-comply-verify',   source: 'comply',       target: 'verification',  markerEnd: dotArrow,   style: { stroke: '#534AB7', strokeWidth: 1.5, strokeDasharray: '5 4' }, label: 'controls check',  labelStyle: { fill: '#534AB7', fontSize: 11 }, labelBgStyle: { fill: '#fbfbfa' } },
];
