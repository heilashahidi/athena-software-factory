...
**Commit:** Enumerate the floor as concrete rules in §6.
**Anchor:** §6 Security policy gate.
...
**Commit:** Name the redaction/classifier components in §security and §8.
**Anchor:** §security; §8 trace/memory.
...
**Commit:** Map to named controls with retention + immutability in §security.
**Anchor:** §security; §2 audit trail.
...
**Anchor:** §3 exemplar store (engine-keyed).
...
**Anchor:** §4 failure recovery (specify retry-with-context + upstream-fault escalation).
